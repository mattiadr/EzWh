...
describe("set User", () => {
    ...
    test('new User', async () => {
        const User1 = new User(1,"John","Snow","john.snow@supplier.ezwh.com","supplier");
        const User2 = new User(2,"Michael","Jordan","michael.jordan@supplier.ezwh.com","supplier");
    ...
    test('update User', async () => {
        const User1 = new User(1,"John","Snow","john.snow@supplier.ezwh.com","supplier");
        const User2 = new User(2,"Michael","Jordan","michael.jordan@supplier.ezwh.com","clerk");       
