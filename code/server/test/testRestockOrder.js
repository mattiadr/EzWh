...
describe('test Restock Order apis', () => {
    ...
    before(async () => {
        ...
        await agent.post('/api/item').send({
            "id": 1, "description": "a product",
        ...
        await agent.post('/api/skuitems/testResult').send({
            "rfid": "12345678901234567890123456789016", "idTestDescriptor": 1,
    ...
    newRestockOrder(422, "2021/11/29 09:33", products1, 1);
    newRestockOrder(201, "2021/11/29 09:33", products1, 2);
    ...
    const restockOrders = [{ "id": 1, "issueDate": "2021/11/29 09:33", "state": "DELIVERY", "products": products1, "supplierId": 2, "transportNote": { "deliveryDate": "2021/11/30" }, "skuItems": [] },
